...
class peopleListAdapter(
    ...
    var tag = "peopleListAdapter"
    lateinit var binding: PeoplelistItemBinding

    // create new views
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        // inflates the card_view_design view
        // that is used to hold list item
        binding = PeoplelistItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
